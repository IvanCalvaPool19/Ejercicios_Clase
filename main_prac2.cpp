...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glBegin(GL_LINE_LOOP);         //GL_PONITS (puntos), GL_LINES (lineas), GL_LINES_LOOP (unir lineas), GL_TRIANGLES (triangulo), GL_QUADS (cuadrado), GL_POLYGON (crea un poligono sin importar vertices los toma)
	
	glColor3f(1.0f, 0.0f, 0.0f);     //Cambio de colores, se pueden hacer degradados dependiendo donde se coloque el glColor (entre vertices)

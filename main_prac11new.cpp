...
Practica #11
Visual Studio 2017
Programa que Muestra como baila muñeco*/
...
float posX =0, posY = 2.5, posZ =-3.5, rotRodIzq = 0, rotRodDer = 0, rotManIzq = 0, rotManDer = 0, rotCab = 0 ; //Manipulacion muñeco
float giroMonito = 0;
...
void monito()
{
	...
	glPushMatrix();//Pecho
		...
		glPushMatrix();//Cuello
			...
			glRotatef(45 + rotCab, 1, 0, 0);
			fig7.cilindro(0.25, 0.25, 15, 0);
			glPushMatrix();//Cabeza
				glTranslatef(0, 1.0, 0);
				glRotatef(45 + rotCab, 0, 0, 1);
